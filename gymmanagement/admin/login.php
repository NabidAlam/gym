...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    ...
    if (empty($_POST["username"])) {
		...
		$sql = mysql_query(" SELECT `name` FROM `admin` WHERE `name` = '$username' ");
	...
	if ($flag !=1) {
		...
		$sql = mysql_query("SELECT * FROM admin WHERE name = '$username' AND password = '$password'") or die(mysql_error());  // query the person
...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="D:/Installed Softz/xampp/htdocs/www/lookgood/admin/css/bootstrap.min.css" rel="stylesheet">
